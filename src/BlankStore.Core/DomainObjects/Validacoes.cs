...
namespace BlankStore.Core.DomainObjects
{
    public class Validacoes
    {
        ...
        public static void ValidarSeMenorOuIgual(long valor, long minimo, string mensagem)
        {
        ...
        public static void ValidarSeMenorOuIgual(double valor, double minimo, string mensagem)
        {
            if (valor < minimo || valor == minimo)
            {
                throw new DomainException(mensagem);
        ...
        public static void ValidarSeMenorOuIgual(int valor, int minimo, string mensagem)
        {
            if (valor < minimo || valor == minimo)
            {
                throw new DomainException(mensagem);
        ...
        public static void ValidarSeMenor(long valor, long minimo, string mensagem)
        {
            if (valor < minimo)
            {
                throw new DomainException(mensagem);
        ...
        public static void ValidarSeMenor(double valor, double minimo, string mensagem)
        {
            if (valor < minimo)
            {
                throw new DomainException(mensagem);
        ...
        public static void ValidarSeMenor(decimal valor, decimal minimo, string mensagem)
        {
            if (valor < minimo)
            {
                throw new DomainException(mensagem);
        ...
        public static void ValidarSeMenor(int valor, int minimo, string mensagem)
        {
            if (valor < minimo)
            {
                throw new DomainException(mensagem);
        ...
        public static void ValidarSeMaior(long valor, long minimo, string mensagem)
        {
            if (valor > minimo)
            {
                throw new DomainException(mensagem);
        ...
        public static void ValidarSeMaior(double valor, double minimo, string mensagem)
        {
            if (valor > minimo)
            {
                throw new DomainException(mensagem);
        ...
        public static void ValidarSeMaior(decimal valor, decimal minimo, string mensagem)
        {
            if (valor > minimo)
            {
                throw new DomainException(mensagem);
        ...
        public static void ValidarSeMaior(int valor, int minimo, string mensagem)
        {
            if (valor > minimo)
            {
                throw new DomainException(mensagem);
